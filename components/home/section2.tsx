      ...
      <div className="col-lg-9">
        <div className="white_block white_block_transparent count_block_whiteblock">
          ...
          <div className="include_details">
            <div>
              <img loading="lazy" className="rounded-whats-img" srcSet="/img/whats/tiny_v3/mudgar.webp 480w,/img/whats/tiny_v3/mudgar.webp 800w" sizes="(max-width: 600px) 480px, 800px" src="/img/whats/tiny_v3/mudgar.webp" />
          ...
          <div className="include_details">
            <div>
              <img loading="lazy"className="rounded-whats-img" srcSet="/img/whats/tiny_v3/45min.webp 480w,/img/whats/tiny_v3/45min.webp 800w" sizes="(max-width: 600px) 480px, 800px" src="/img/whats/tiny_v3/45min.webp" />
              <div className="include_details_bg">
          ...
          <div className="include_details">
            <div>
              <img loading="lazy" className="rounded-whats-img" srcSet="/img/whats/tiny_v3/3.webp 480w,/img/whats/tiny_v3/3.webp 800w" sizes="(max-width: 600px) 480px, 800px" src="/img/whats/tiny_v3/3.webp" />
              <div className="include_details_bg">
          ...
          <div className="include_details">
            <div>
              <img loading="lazy" className="rounded-whats-img" srcSet="/img/whats/tiny_v3/Maintainance.webp 480w,/img/whats/tiny_v3/Maintainance.webp 800w" sizes="(max-width: 600px) 480px, 800px" src="/img/whats/tiny_v3/Maintainance.webp" />
              <div className="include_details_bg">
