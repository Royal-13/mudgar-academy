...
return (
    ...
    <div id="curriculum" className="white_block text-center curriculum">
        <h3 className="brown_heading py-3">Different types of swings that you will learn:</h3>
          ...
          <div className="content-item active">
            <div className="grid gtc curr-sm-2 curr-md-2 curr-lg-2 curr_grid">
              ...
              <div className="curr_right d-flex d-sm-block align-content-center flex-wrap">
                ...
                <div className="heading_cur3">Swings that target the shoulders and chest.
                </div>
              </div>
              <div className="curr_left">
              ...
              <div className="curr_right d-flex d-sm-block align-content-center flex-wrap">
                ...
                <div className="heading_cur3">Swings that target the triceps and biceps.
                </div>
              </div>
              <div className="curr_left">
              ...
              <div className="curr_right d-flex d-sm-block align-content-center flex-wrap">
                ...
                <div className="heading_cur3">Swings that target the wrists and forearms.
                </div>
              </div>
              <div className="curr_left">
              ...
              <div className="curr_right d-flex d-sm-block align-content-center flex-wrap">
                ...
                <div className="heading_cur3">Swings that target the spine and core.
                </div>
              </div>
              <div className="curr_left">
              ...
              <div className="curr_right d-flex d-sm-block align-content-center flex-wrap">
                ...
                <div className="heading_cur3">Swings that target the legs.
                </div>
              </div>
            </div>
          </div>
