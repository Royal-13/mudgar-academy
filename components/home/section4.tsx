      ...
      <div id="who" className="white_block who ">
        ...
        <div className="row">
          <div className="col-lg-6">
            <img loading="lazy" src="/img/who/100.png" alt="healthy" height={70} />
          ...
          <div className="col-lg-6">
            <img loading="lazy" src="/img/who/101.png" alt="healthy" height={70} />
        ...
        <div className="row">
          <div className="col-lg-6">
            <img loading="lazy" src="/img/who/102.png" alt="healthy" height={70} />
          ...
          <div className="col-lg-6">
            <img loading="lazy" src="/img/who/103.png" alt="healthy" height={70} />
        ...
        <div className="row">
          <div className="col-lg-6">
            <img loading="lazy" src="/img/who/104.png" alt="healthy" height={70} />
          ...
          <div className="col-lg-6">
            <img loading="lazy" src="/img/who/105.png" alt="healthy" height={70} />
      ...
      <div id="who_not" className="white_block who">
        ...
        <div className="row">
          <div className="col-lg-6 d-block d-sm-flex align-items-center justify-content-center justify-content-sm-start pb-3 pb-sm-0">
            <img loading="lazy" src="/img/not_for/100.png" alt="healthy" width={70} />
            <h3 className="heading_who ps-2">Pregnant women in<br />their third trimester</h3>
          </div>
          <div className="col-lg-6 d-block d-sm-flex align-items-center justify-content-center justify-content-sm-start pb-3 pb-sm-0">
            <img loading="lazy" src="/img/not_for/101.png" alt="healthy" width={70} />
            <h3 className="heading_who ps-2">Elderly citizens with<br />chronic diseases</h3>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-6 d-block d-sm-flex align-items-center justify-content-center justify-content-sm-start pb-3 pb-sm-0">
            <img loading="lazy" src="/img/not_for/102.png" alt="healthy" width={70} />
            <h3 className="heading_who ps-2">Children under<br /> age of 14</h3>
          </div>
          <div className="col-lg-6 d-block d-sm-flex align-items-center justify-content-center justify-content-sm-start pb-3 pb-sm-0">
            <img loading="lazy" src="/img/not_for/103.png" alt="healthy" width={70} />
